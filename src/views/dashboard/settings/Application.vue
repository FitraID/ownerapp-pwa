<template>
  <setting-layout :title="'Application'" :activeSettingMenu="2">
    <div class="card-body">
      <div class="row">
            ...
            <div class="card-body">
              <form @submit.prevent="" action="#">
                <div class="row g-3">
                  ...
                  <div class="col-sm-6">
                    <label class="form-label">Currency Default</label>
                    <select class="form-select">
                  ...
                  <div class="col-12">
                    <button class="btn btn-success ps-5 pe-5 waves-effect">
                      Save
                    </button>
                  </div>
                </div>
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-check form-switch mb-3">
                    ...
                    <label class="form-check-label" for="s3"
                      >There are recommendation for my sccount</label
                    >
                  </div>
                </div>
